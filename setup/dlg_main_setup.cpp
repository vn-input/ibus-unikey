...
void init_dialog_controls(GtkBuilder* builder)
{
    ...
    ibus_unikey_config_get_boolean(CONFIG_SPELLCHECK, &b);
    ...
    ibus_unikey_config_get_boolean(CONFIG_AUTORESTORENONVN, &b);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(wid), b);
    ...
    ibus_unikey_config_get_boolean(CONFIG_MODERNSTYLE, &b);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(wid), b);
    ...
    ibus_unikey_config_get_boolean(CONFIG_FREEMARKING, &b);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(wid), b);
    ...
    ibus_unikey_config_get_boolean(CONFIG_MACROENABLED, &b);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(wid), b);
    ...
    ibus_unikey_config_get_boolean(CONFIG_STANDALONEW, &b);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(wid), b);
